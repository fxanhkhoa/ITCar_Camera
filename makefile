...
mainmake: itcar_contours.cpp TK1_DRIVER/Controller.cpp TK1_DRIVER/JHPWMPCA9685.cpp
	$(CC) itcar_contours.cpp TK1_DRIVER/Controller.cpp TK1_DRIVER/JHPWMPCA9685.cpp -o output $(LIBS)
	@echo 'done'
